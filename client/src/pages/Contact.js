...
const Contact = () => {
  return(
    <div className="lg:grid lg:grid-cols-2 lg:gap-5 xl:gap-7 opacity-[50%] mt-10 md:mt-16 mx-2 sm:mx-10 md:mx-12 xl:mt-24">
      ...
      <div>
        <form className='mt-5 md:mt-10 lg:mt-2'>
          <input type='text' placeholder='Name' className='border-2 border-[#0688FF] p-1 md:p-2 w-full rounded-[10px] md:text-[22px]'/>
          <input type='text' placeholder='Subject' className='border-2 border-[#0688FF] p-1 mt-2 md:mt-4 md:p-2 w-full rounded-[10px] md:text-[22px]'/>
          <textarea placeholder='Message' rows={5} className='border-2 border-[#0688FF] p-1 mt-2 md:mt-4 md:p-2 w-full rounded-[10px] md:text-[22px]'/>
