  ...
  return (
    <div>
      <div className='sm:mx-2 lg:mx-6 '>
        <div className='my-5 sm:flex sm:justify-center sm:items-center'>
          <div className='sm:w-[88%] sm:m-3'>
            <img 
          ...
          <div className='mt-5 sm:m-3 sm:col-span-2'>
            ...
            <div className='bg-[#31A727] bg-opacity-[50%] rounded-[20px] p-4'>
              ...
              <button className='mt-2 bg-white rounded-full px-[7px] text-[18px] lg:text-[20px] text-[#31A727] text-opacity-[50%]'>React</button>
            </div>
        ...
        <div className='my-5 sm:mt-0 bg-[#0688FF] bg-opacity-[50%] rounded-[20px] p-5 text-white text-center text-[18px] sm:text-[20px] xl:text-[26px] col-span-5'>
          <p>
