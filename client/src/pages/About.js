    ...
    <section>
      ...
      <div className='text-white'>
        ...
        <div className='mt-[70px] sm:mt-[50px]'>
          <div className="bg-[#31A727] bg-opacity-[50%] rounded-[20px] py-[90px] sm:py-[60px] md:py-[30px] px-5 sm:pr-11 md:pr-12 text-center sm:text-left sm:w-3/4">
            <h1 className='font-bold drop-shadow-md text-[24px]'>
            Graduated from the University of Tennessee with a B.A. in Psychology
            </h1>
            <h3 className='font-light drop-shadow-md text-[21px]'>May 2020</h3>
            <p className='font-medium drop-shadow-md text-[18px] pt-3'>
        ...
        <div className='hidden sm:flex sm:justify-end sm:items-center'>
            <img 
              className="absolute w-[150px] sm:w-[200px] md:w-[220px] mdplus:w-[250px] md:mr-5 mdplus:mr-10 rounded-full border-[10px] border-white"
              src={School}
              alt="Logo"
            />
          </div>
        ...
        <div  className='sm:flex sm:items-center sm:mr-5 md:mr-10'>
          <div className='flex justify-start items-center'>
            <img 
              className="absolute w-[150px] sm:w-[200px] md:ml-5 rounded-full border-[10px] border-white"
              src={Americorp}
              alt="Logo"
            />
          </div>
          <div className='mt-5 sm:flex sm:justify-end'>
            <div className="bg-[#0688FF] bg-opacity-[50%] rounded-[20px] pb-[90px] pt-[70px] sm:py-[60px] md:py-[30px] px-5 sm:pl-11 text-center sm:text-right sm:w-3/4">
              <h1 className='font-bold drop-shadow-md text-[24px]'>
              Served as an AmeriCorps member in Montana
              </h1>
              <h3 className='font-light drop-shadow-md text-[21px]'>August 2020</h3>
              <p className='font-medium drop-shadow-md text-[18px] pt-3'>
        ...
        <div className='flex justify-end items-center'>
          <img 
            className="absolute w-[150px] rounded-full border-[10px] border-white"
            src={Vandy}
            alt="Logo"
          />
        </div>
        <div className='mt-5'>
          <div className="bg-[#302DE0] bg-opacity-[50%] rounded-[20px] pb-[90px] pt-[70px] px-5 text-center">
            <h1 className='font-bold drop-shadow-md text-[24px]'>
            Attended Vanderbilt Coding Boot Camp
            </h1>
            <h3 className='font-light drop-shadow-md text-[21px]'>December 2021</h3>
            <p className='font-medium drop-shadow-md text-[18px] pt-3'>
        ...
        <div className='mt-5'>
          <div className="bg-[#31A727] bg-opacity-[50%] rounded-[20px] pb-[90px] pt-[70px] px-5 text-center">
            <h1 className='font-bold drop-shadow-md text-[24px]'>
            Continuing Education
            </h1>
            <h3 className='font-light drop-shadow-md text-[21px]'>May 2022 - Present</h3>
            <p className='font-medium drop-shadow-md text-[18px] pt-3'>
