...
const ImageForm = () => {
  ...
  return(
    <section className="flex flex-col justify-center items-center">
      <h1 className="opacity-[50%]">Upload images that will be used in this article:</h1>
        ...
        <div>
          <h1 className="text-center opacity-[50%]">Click on an image to copy the URL to clipboard</h1>
          <div className="flex">
