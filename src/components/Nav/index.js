...
<>
    ...
    <div className="flex items-center w-full sm:block ">
          ...
          " sm:justify-center sm:static fixed rounded-xl bottom-15 top-12 sm:flex sm:space-x-7 items-center sm:bg-transparent bg-blue-50  sm:w-full w-full sm:text-purple-100 text-white sm:space-y-0 space-y-5 p-2 transition-left"
                ...
                <li>
                    <Link to="/shop" className="drop-shadow-lg shadow-black text-purple-50 dark:text-purple-50 hover:underline hover:text-white">About</Link>
                </li>
                <li>
                    <Link to="/gallery" className="drop-shadow-lg shadow-black text-purple-50 dark:text-purple-50 hover:underline hover:text-white">Portfolio</Link>
                </li>
                <li>
                    <Link to="/blog" className="drop-shadow-lg shadow-black text-purple-50 dark:text-purple-50 hover:underline hover:text-white">Contact</Link>
                </li>
            </ul>
        </div>
          {showNav ? (
